...
if (!exists("TEST") || is.null(TEST)) {
  ...
  # Testing mode
  report_params <- parse_params("/blue/cancercenter-dept/PROJECTS/CHENGGUO_XING/MOUSE_LIVER_4WEEK_TOBACCO_KAVA/Downstream_Analysis/nfcore-rmarkdown-report-module/CX_liver_report_params.txt")
}
...
plot_pca_combined(dge_list, grp_var = "Condition", annotation_labels = annotation_labels)
if (!is.null(report_params$batch_var) && report_params$batch_var == "Batch") {
